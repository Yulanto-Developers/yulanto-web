          ...
          <div className="col-xl-9">
            <div className="px-project-title-box">
              ...
              <h1
                ...
                data-aos-delay="100"
              >
                Web Design & Development Companies in Chennai for All Industries
              </h1>
              <p className="text-figtree text-dark mt-2 font-paragraph-cls">
                We deliver innovative web and digital solutions for businesses
                across diverse industries. From startups to established
                enterprises, our industry-focused approach creates impactful
                digital experiences that drive growth and deliver results.
              </p>
            </div>
          </div>
        </div>
