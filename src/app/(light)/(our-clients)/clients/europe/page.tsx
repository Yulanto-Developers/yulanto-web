        ...
        <div style={styles.container} className="dx-grid-2">
          <div>
            <span style={styles.heroBadge}>
              <Flag size={14} style={{ color: colors.brand }} /> Trusted by Enterprises Across Europe, North America, Middle East & Asia
            ...
            <p className="text-figtree font-paragraph-cls text-black">
              We build high-performance digital solutions that empower enterprises and SMEs to grow, scale, and lead worldwide. Discover our completed platforms and web solutions delivered for premier clients in Europe, Canada, the US, Middle East, and Asia.
            </p>
        ...
        <div style={styles.container}>
          <div style={{ textAlign: "center", marginBottom: 40 }}>
            ...
            <p className="text-figtree font-paragraph-cls text-black" style={{ maxWidth: 680, margin: "0 auto" }}>
              We take pride in building tailored digital experiences for leading engineering firms, tech solutions providers, event designers, community services, and maritime leaders worldwide.
            </p>
          </div>
      ...
      <section id="technologies" className="section-bg-alt" style={styles.section}>
        <div style={styles.container} className="dx-grid-rw">
          <div>
            ...
            <p className="text-figtree font-paragraph-cls text-black">
              We are proud to collaborate with market leaders across Europe, North America, Middle East, and Asia. We specialize in delivering end-to-end digital engineering and interactive platforms designed for high scalability, security, accessibility compliance, and search engine optimization.
            </p>
      ...
      <section id="testimonials" className="section-bg-white" style={styles.section}>
        <div style={styles.container} className="dx-grid-2">
          ...
          <div>
            ...
            <p className="text-figtree font-paragraph-cls text-black">
              Our committed regional delivery team has supported brands in maritime engineering, IT infrastructure, event design, community accessibility, cleaning services, industrial tech, and energy globally.
            </p>
