...
/**
 * DigitizeXPage - SG & MY Regional Edition
...
const TESTIMONIALS: TestimonialItem[] = [
  ...
  {
    text: "Working with DigitizeX to scale our event logistics booking platform was smooth and efficient. Excellent understanding of the Singapore market.",
    name: "Rachel Lim",
    role: "Marketing Manager, SG Event Rental",
    img: "https://i.pravatar.cc/80?img=47",
  },
  {
    text: "The web and platform architecture delivered by DigitizeX gave our studio brand the modern digital footprint we needed across Southeast Asia.",
    name: "Ahmad Rizal",
...
const HERO_STATS: StatItem[] = [
  ...
  { icon: Users, color: "#e0555a", bg: "#fdeeee", value: "SG & MY", label: "Primary Markets" },
];
        ...
        <div style={styles.container} className="dx-grid-2">
          <div>
            <span style={styles.heroBadge}>
              <Flag size={14} style={{ color: colors.brand }} /> Trusted by Businesses Across Singapore & Malaysia
              <BadgeCheck size={14} style={{ color: colors.brand }} />
            </span>

            <h4 className="px-about-title mb-20">
              <span className="text-blue-about">Our Successful</span> Singapore & Malaysia Client Projects
            </h4>
            <p className="text-figtree font-paragraph-cls text-black">
              We build high-performance digital solutions that empower enterprises and SMEs to grow, scale, and lead in
              Southeast Asia. Discover our completed platforms and solutions delivered for premier clients in Singapore &
              Malaysia.
            </p>
      ...
      <section id="about" className="section-bg-white" style={styles.section}>
        <div style={styles.container}>
          <div style={{ maxWidth: 800 }}>
            ...
            <p className="text-figtree font-paragraph-cls text-black">
              DigitizeX is a premier digital engineering and tech consultancy enabling organizations across Singapore, Malaysia,
              and Southeast Asia to thrive online. We unite creative UX strategy, robust cloud technologies, and industry-standard
              development practices to construct high-performing websites, web apps, enterprise web applications, and custom digital portals.
            </p>
          </div>
        </div>
      </section>
      ...
      <section id="work" className="section-bg-white" style={styles.section}>
        <div style={styles.container}>
          <div style={{ textAlign: "center", marginBottom: 40 }}>
            ...
            <h3 className="px-section-title text-tenor font-title-cls text-effect mb-20">
              <span className="word">Featured Singapore & Malaysia Clients</span>
            </h3>
      ...
      <section id="technologies" className="section-bg-alt" style={styles.section}>
        <div style={styles.container} className="dx-grid-rw">
          <div>
            ...
            <p className="text-figtree font-paragraph-cls text-black">
              We are proud to collaborate with esteemed market leaders across Singapore and Malaysia. We specialize in delivering end-to-end digital engineering and interactive platforms designed for high scalability, cloud security, and regional search visibility.
            </p>
            <p className="text-figtree font-paragraph-cls text-black" style={{ marginTop: 12 }}>
              From initial architecture planning to UI/UX design, custom frontend and backend integration, continuous deployment, and ongoing optimization, our regional engineering team ensures precision execution every step of the way.
            </p>
          </div>
      ...
      <section id="testimonials" className="section-bg-white" style={styles.section}>
        <div style={styles.container} className="dx-grid-2">
          <div>
            ...
            <h4 className="px-about-title mb-20">
              <span className="text-blue-about">What Our</span> Regional Clients Say
            </h4>
          ...
          <div>
            ...
            <p className="text-figtree font-paragraph-cls text-black">
              Our committed regional delivery team has supported brands in industrial engineering, eco-tech solutions, event management, media, and animation studios across Singapore and Malaysia.
            </p>
      ...
      <section id="contact" className="section-bg-alt" style={{ padding: "64px 0" }}>
        <div style={styles.container} className="dx-grid-cta">
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-start", gap: 20 }}>
            ...
            <p className="text-figtree font-paragraph-cls text-black">
              Let&apos;s Build Something Extraordinary Together for Singapore, Malaysia & SEA!
            </p>
