...
/**
 * DigitizeXPage - Regional Edition (UK & Denmark Added)
...
const CLIENTS: ClientItem[] = [
  // --- UK - LONDON ---
  {
    name: "Amen Dry Cleaners",
    brand: "AMEN DRY CLEANERS",
    domain: "amendrycleaners.co.uk",
    category: "Professional Garment Care & Laundry Services",
    color: "#2563eb",
    flag: "🇬🇧",
    icon: Shirt,
  },
  {
    name: "LDF Kormesic",
    brand: "LDF KORMESIC",
    domain: "ldfkormesic.com",
    category: "Cosmetics & Skincare Solutions",
    color: "#db2777",
    flag: "🇬🇧",
    icon: Sparkles,
  },
  ...
  // --- DENMARK ---
  {
    ...
    brand: "DHH GROUP",
    domain: "dhhgroup.dk",
    category: "Corporate Holding & Business Consulting",
    color: "#dc2626",
    flag: "🇩🇰",
    icon: Briefcase,
  },

  // --- EUROPE & EAST WINDSOR (USA) ---
  {
    name: "Altis Marine",
    brand: "ALTIS MARINE",
    domain: "altismarine.eu",
    category: "Marine Engineering & Services",
    color: "#0369a1",
    flag: "🇪🇺",
    icon: Ship,
  },
  {
    ...
    brand: "INTRAHOP TECH",
    domain: "intrahoptechnologies.com",
  ...
  // --- CANADA ---
  {
    ...
    brand: "GTA BALLOONS",
    domain: "gtaballoonsdesigners.com",
    category: "Event Decor & Design",
    color: "#ec4899",
    flag: "🇨🇦",
    icon: SparklesIcon,
  },
  {
    ...
    brand: "QUICK BRIGHT",
    domain: "quickbrightcleaning.com",
    category: "Commercial & Residential Cleaning",
    color: "#0284c7",
    flag: "🇨🇦",
    icon: Sparkle,
  },
  {
    ...
    brand: "DANFORTH DISABILITY",
    domain: "danforthdisabilityservices.com",
    category: "Accessibility & Community Support",
    color: "#059669",
    flag: "🇨🇦",
    icon: HeartHandshake,
  },
...
const TESTIMONIALS: TestimonialItem[] = [
  {
    text: "DigitizeX transformed our digital web portal with seamless engineering precision. Their turnaround time and responsiveness were outstanding!",
    name: "Tan Min-Wei",
    role: "Operations Director, Altis CalServ",
    img: "https://i.pravatar.cc/80?img=12",
  },
  {
    text: "Working with DigitizeX to scale our event logistics platform was smooth and efficient. Excellent understanding of our global market needs.",
    name: "Rachel Lim",
    ...
    <div style={styles.root}>
        ...
        <div style={styles.container} className="dx-grid-2">
          <div>
            <span style={styles.heroBadge}>
              <Flag size={14} style={{ color: colors.brand }} /> Trusted by Enterprises Across UK, Denmark, Europe, North America & Asia
            ...
            <p className="text-figtree font-paragraph-cls text-black">
              We build high-performance digital solutions that empower enterprises and SMEs to grow, scale, and lead worldwide. Discover our completed platforms and web solutions delivered for premier clients in the UK, Denmark, Europe, Canada, the US, Middle East, and Asia.
            </p>
      ...
      <section id="about" className="section-bg-white" style={styles.section}>
        <div style={styles.container}>
          <div style={{ maxWidth: 800 }}>
            ...
            <p className="text-figtree font-paragraph-cls text-black">
              DigitizeX is a premier digital engineering and tech consultancy enabling organizations worldwide to thrive online. We unite creative UX strategy, robust cloud technologies, and industry-standard development practices to construct high-performing websites, web apps, enterprise web applications, and custom digital portals across global markets.
            </p>
          </div>
        </div>
      </section>
        ...
        <div style={styles.container}>
          <div style={{ textAlign: "center", marginBottom: 40 }}>
            ...
            <p className="text-figtree font-paragraph-cls text-black" style={{ maxWidth: 680, margin: "0 auto" }}>
              We take pride in building tailored digital experiences for dry cleaning services, cosmetics brands, holding groups, engineering firms, tech solutions providers, event designers, community services, and maritime leaders worldwide.
            </p>
          </div>
      ...
      <section id="technologies" className="section-bg-alt" style={styles.section}>
        <div style={styles.container} className="dx-grid-rw">
          <div>
            <h4 className="px-about-title mb-20">
              <span className="text-blue-about">Our Global</span> Work Standard
            </h4>
            <p className="text-figtree font-paragraph-cls text-black">
              We are proud to collaborate with market leaders across London, Denmark, Europe, North America, Middle East, and Asia. We specialize in delivering end-to-end digital engineering and interactive platforms designed for high scalability, security, accessibility compliance, and search engine optimization.
            </p>
            <p className="text-figtree font-paragraph-cls text-black" style={{ marginTop: 12 }}>
              From initial architecture planning to UI/UX design, frontend and backend integration, continuous deployment, and ongoing technical maintenance, our engineering team ensures precision execution every step of the way.
            </p>
          </div>
      ...
      <section id="testimonials" className="section-bg-white" style={styles.section}>
        <div style={styles.container} className="dx-grid-2">
          ...
          <div>
            ...
            <p className="text-figtree font-paragraph-cls text-black">
              Our committed regional delivery team has supported brands in London garment care, cosmetics, Danish holdings, maritime engineering, IT infrastructure, event design, community accessibility, cleaning services, industrial tech, and energy globally.
            </p>
