      ...
      <div className="container container-1550 ">
        ...
        <div className="row align-items-center">
          ...
          <div className="col-xl-6 col-lg-6 mb-5 mb-lg-0">
            ...
            >
              <span 
                className="tp-section-subtitle text-black blink-ball mb-3 inline-block" 
                data-aos="fade-down" 
                data-aos-delay="300"
              >
                Google Ads
          ...
          {/* Right Side Column - Product Mockups */}
          {showMockups && (
            <div className="col-xl-6 col-lg-6">
              ...
              >
                {/* Main Desktop Application Window Mockup */}
                <div
                  data-aos="fade-left"
                  data-aos-delay="200"
                  style={{
                  ...
                  <div style={{ padding: "32px", backgroundColor: "#ffffff", minHeight: "320px" }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: "32px" }}>
                      <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                        <h3 style={{ color: "#64748b", fontWeight: 500, margin: 0, fontSize: "16px" }}>Campaign ROI Performance</h3>
                ...
                {/* Stacked Background Accent Cards */}
                <div
                  data-aos="fade-left"
                  data-aos-delay="100"
                  style={{
