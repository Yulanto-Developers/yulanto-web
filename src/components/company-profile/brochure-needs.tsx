...
export function BrochureNeeds({}: Readonly<BrochureNeedsProps>) {
  ...
  const leftList = [
    ...
    {
      title: "Real estate and construction companies",
      icon: "fa-solid fa-city",
    },
    {
      title: "Industrial and manufacturing businesses",
  ...
  const rightList = [
    {
      title: "Healthcare and service businesses",
        ...
        <div className="row align-items-center" data-aos="fade-up">
          <div className="col-xl-12">
            <div className="px-project-title-box">
              ...
              <h1
                className="ft-23 mt-0 mb-3 text-center text-white text-tenor"
                data-aos="text-reveal"
                data-aos-delay="100"
                style={{ lineHeight: "1.2" }}
              >
                Graphic Design Company and Brochure Design Company
              </h1>
