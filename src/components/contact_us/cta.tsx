...
const BlogDetailsArea = () => {
  return (
    <>
      ...
      `}</style>
      {/* -- postbox area start -- */}
      <section id="postbox" className="postbox-area pt-3 pt-md-4 pb-3 pb-md-4">
                  ...
                  <blockquote>
                    <div className="postbox-details-quote-wrap d-flex align-items-start">
                      ...
                      <div className="postbox-details-quote col-lg-8">
                        <p>
                          “Let’s turn your ideas into impactful digital
                          experiences. Whether you have a question, need
                          guidance, or are ready to start a project, our team is
                          here to help. Get in touch with us or visit our office
                          for a conversation over a cup of coffee.”
                        </p>
                      </div>
                      <div className="col-lg-4">
                        <div className="tp-contact-us-img">
                          <Image
                            src="/assets/img/tocontact/QR2.png"
                            alt="Contact Us"
                            width={170}
                            height={170}
                          />
