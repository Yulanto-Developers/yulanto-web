...
export default function Industry() {
    ...
    const activeCategoryObj = INDUSTRIES.find(item => item.id === activeIndustry);

    // Get current projects list
    const currentIndustryData = INDUSTRY_CONTENT[activeIndustry] || { projects: [] };
        ...
        <section className="industry-section">
            <div className="industry-container">
                ...
                <div className="industry-header">
                    ...
                    <h2 className="industry-heading">Filter By Industry</h2>
                ...
                <div className="industry-layout">
                    ...
                    <aside className="filter-sidebar">
                        <div className="filter-card">
                            <nav className="filter-nav" role="tablist">
