...
function Startupwebsitedesign() {
  ...
  const industries = [
    ...
    },
    {
      ...
      icon: <FaGlobe />,
      image: v9.src,
      description: "Global-facing websites for import and export companies.",
    },
    {
      id: 10,
  ...
  const startupProcessContent = [
...

    {
      ...
      description: (
        <>
          Our <strong>web designers in Chennai</strong> focus on intuitive
          navigation, responsive layouts, readable content, clear information
  ...
  const ambassadorCard = {
    default: {
      ...
      content: (
        <>
          Our completed projects and long-term client relationships demonstrate
          the quality of our work.{" "}
          <strong>Our success speaks for us—not just our sales pitch.</strong>
        </>
      ),
    },
    ...
    hover: {
      ...
      content: (
        <>
          Looking for the <strong>best web design in Chennai</strong> for your
          startup? Talk to our team today and take the first step towards
          building a professional, credible, and growth-focused online presence.
        </>
      ),
    },
  };
  ...
  const startupGalleryImages = [
    ...
    },
    {
      id: 3,
      src: t3.src,
      alt: "website designers in chennai",
      x: 0,
      y: 8,
      order: 2,
      zIndex: 30,
    ...
    },
    {
      id: 4,
      src: t4.src,
      alt: "website developers in chennai",
      x: 160,
      y: 22,
      order: 3,
      zIndex: 20,
...
`}</style>
      ...
      <IntroContent
        ...
        description={
          "Launch your business with a professional, high-performing website designed to build credibility, attract customers, and support long-term growth. "
        }
        css="mt-5"
      />
        ...
        <div className="row align-items-center">
          ...
          <div className="col-md-7">
            ...
            <p className="text-figtree">
              As an experienced web designing company in Chennai, Yulanto Web
              Creations creates tailor-made websites for startups and emerging
              businesses across different industries.
              <br />
              <br />
              Your website is often the first interaction a potential customer
              has with your brand. A well-planned web design in Chennai can help
              you establish a strong online presence, showcase your products or
              services, communicate your brand values, and convert visitors into
              customers.
            </p>
          </div>
        ...
        <div className="container">
          <div className="row align-items-center pt-50 pb-50">
            <div className="col-12">
              ...
              <h4 className="px-about-title mb-20">
                <span className="text-blue-about">Special Focus on</span>{" "}
                Startup Web Designing
              </h4>
            </div>
            ...
            <div className="col-md-8">
              <h1
                ...
                data-aos-delay="100"
              >
                Website Design Services in Chennai for Startup Businesses
              </h1>

              <p className="text-figtree pt-md-0 pt-2 ">
                Our experienced web designers in Chennai specialize in creating
                innovative, attractive, responsive, and user-friendly websites
                for startups. We combine creative design, intuitive navigation,
                mobile responsiveness, SEO-friendly development, and
                conversion-focused layouts to help new businesses establish a
                strong digital presence. Whether you are launching a new
                product, introducing a service, or building a completely new
                brand, our team develops website solutions aligned with your
                business objectives and target audience. From a startup idea to
                a professional online presence, we design websites that help
          ...
          <div className="row">
            <div className="col-xl-12">
              <div className="px-project-title-box">
                ...
                <h4 className="px-about-title mb-20 text-white">
                  <span className="">Enhance Your Startup </span>Growth with a
            ...
            <div className="col-12 d-flex flex-column align-items-start mb-4">
              <p className="text-figtree text-white">
                Choosing the right web design agency in Chennai can make a
                significant difference to your startup's online growth. Every
                business has a unique identity, target audience, and business
                objective. Therefore, we create customized website designs
                rather than relying on one-size-fits-all solutions.
              </p>

              <p
                className="text-figtree text-white mt-2 mb-3"
                style={{ fontSize: "1.05rem" }}
              >
                Our startup website design services can support businesses
            ...
            <IndustryGallery industries={industries} />
            <div className="mt-md-50 mt-20">
              <p className="text-white">
                As a professional Chennai design company, we focus on creating
                websites that are visually appealing while also supporting
                usability, search engine visibility, and business growth.
              </p>
            </div>
          </div>
        </div>
      ...
      >
        <div className="row align-items-center">
          ...
          <div>
            <p>
              Designing a website for a startup can be challenging because the
              website needs to establish credibility while clearly communicating
              a new brand's products, services, and unique value proposition. At
              Yulanto, our team combines web designing, UI/UX design, website
              development, SEO, and digital marketing expertise to provide
              startups with a complete digital solution.
            </p>
            <p>
              As a trusted design company in Chennai, we focus on creating
              websites that are:
            </p>
        ...
        <div className="startup-benefits">
          ...
          <div className="startup-benefits-header">
            ...
            <h4 className="px-about-title">
              <span className="text-blue-about">Benefits You Get from </span>
          ...
          <div>
            <div className="container mt-50 mb-20">
              ...
              >
                Affordable Website Design Without Compromising Quality
              </h5>
              <p>
                We understand that startups often operate with limited budgets.
                Our approach combines efficient project planning, practical
                technology selection, and streamlined development to deliver{" "}
                affordable web design in Chennai.
              </p>
            </div>
          </div>
          ...
          {startupBenefitsContent
            ...
            .map((item, index) => {
              ...
              const budgetSections = startupBenefitsContent.filter(
                (content) => content.type === "section" && !content.number,
              );

              return (
                <div key={index} className="startup-budget-card">
                  <div className="startup-budget-top">
                    <div className="startup-budget-icon">
                      {Icon && <Icon size={24} strokeWidth={2} />}
                    </div>

                    <span className="text-tenor">BUDGET-FRIENDLY</span>
                  </div>

                  <h4 className="text-tenor">{item.title}</h4>

                  {budgetSections.map((section, sectionIndex) => (
                    <div key={sectionIndex} className="startup-budget-content">
...
>>>>>>> Stashed changes
              ...
              <p>
                A visually attractive website needs to be discoverable by your
                target audience. That's why SEO considerations are incorporated
                into our website planning and development process. As a best web
                design company in Chennai for businesses looking for design and
                digital growth solutions, we focus on creating SEO-friendly
                website structures that can support search engine optimization.
              </p>
            </div>
          </div>
          ...
          <div className="seo-approach-wrapper">
            <div className="seo-approach-heading">
              <h5 className="fw-bold text-tenor">Our approach can include:</h5>

              <p>
                We focus on the technical and structural elements that help
                create a strong foundation for your SEO and digital marketing
                efforts.
              </p>
            </div>
            ...
            <div className="py-5">
              ...
              <p>
                If you are searching for a reliable web design agency in Chennai
                to create your startup website, Yulanto Web Creations can help
                turn your business idea into a professional digital presence.
                From planning and UI/UX design to website development and
                SEO-ready implementation, our team works closely with you
                throughout the project. Have a startup idea?{" "}
                <span className="startup-typing-wrapper">
                  <span
                    className="startup-typing-text"
                    style={{ color: "#053456" }}
      ...
      <div className="container mt-20 mb-20">
        ...
        <h4 className="px-about-title mb-20">
          <span className="text-blue-about">Our Step-by-Step </span>
          Approach to Startup Web Design
        </h4>
        <p>
          We begin by understanding your startup, products or services, target
          audience, competitors, business objectives, and long-term goals.
        </p>
        ...
        <div className="container">
          <div className="row align-items-center pb-50 pt-50">
            ...
            <div className="col-md-8">
              ...
              <p className="text-figtree text-white ">
                Choosing the right technology and website structure is important
                for startup businesses. Our team explains the available
                technologies, features, functionalities, and digital
                opportunities so that you can make informed decisions.
                {/* <br /> */}
                As an experienced web designing company in Chennai, we provide
                practical recommendations based on your business goals, target
                audience, budget, and future growth plans.
              </p>
            </div>
          </div>
          <div className="row align-items-start pt-20 pb-50">
            ...
            <div className="col-md-8">
              <p className="text-figtree text-white ">
                ...
                for startup businesses. Our team explains the available
                technologies, features, functionalities, and digital
                opportunities so that you can make informed decisions. As an
                experienced web designing company in Chennai, we provide
                practical recommendations based on your business goals, target
                audience, budget, and future growth plans.
                <br /> <br />
                Our experience across different industries enables us to develop
                websites using appropriate technologies and platforms. We
                continually evaluate modern web design practices and
                technologies to improve usability, performance, functionality,
                and scalability.
              </p>
            </div>
        ...
        <div className="container mt-10 mb-20">
          ...
          <div className="why-choose-header">
            ...
            <p>
              Choosing the right technology and website structure is important
              for startup businesses. Our team explains the available
              technologies, features, functionalities, and digital opportunities
      ...
      <div style={{ background: "#f5f5f5" }}>
        <div className="container mt-50 pt-30 pb-30">
          ...
          <p>
            As a web design company in Chennai, we bring together creative
            design, technical development, SEO, and digital marketing expertise
            to help startups build a strong online presence.
            {/* <br /> */}
            Whether you are looking for webdesign Chennai, startup website
            design, responsive web design, WordPress website design, or a
          ...
          <div className="ambassador-card" onClick={openModal}>
            ...
            <div className="ambassador-card-content ambassador-card-default">
              ...
              <h4>{ambassadorCard.default.title}</h4>

              <p>{ambassadorCard.default.content}</p>

              <div className="ambassador-card-hint">
                <span>Hover to explore</span>
                <span className="ambassador-card-arrow">→</span>
              </div>
            </div>

            {/* Hover Content */}
            <div className="ambassador-card-content ambassador-card-hover">
              <span className="ambassador-card-label">GET STARTED</span>

              <h4>{ambassadorCard.hover.title}</h4>
