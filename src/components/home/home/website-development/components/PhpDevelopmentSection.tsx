          ...
          <div className="col-xl-9">
            <div className="px-project-title-box">
              ...
              >
                ...
                experienced PHP developers in Chennai combine modern development
                practices, clean coding standards, and business-focused
                strategies to build websites that are fast, responsive, secure,
                and easy to manage.
              </p>
            </div>
          </div>
          ...
          <div className="col-xl-12 mt-4 text-center">
            ...
            >
              ...
              <g transform="translate(40, 10)">
                ...
                />
                <path
                  d="M 90 98 L 110 98 L 115 116 L 85 116 Z"
                  fill="#64748B"
                />
                <rect
                  x="75"
