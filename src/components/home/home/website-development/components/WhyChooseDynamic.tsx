      ...
      <div className="container px-3 px-sm-4">
          ...
          <div className="col-xl-9">
            <div className="px-project-title-box">
              <h4 className="px-about-title mb-20">
                <span className="text-blue-about">Why Choose Dynamic</span>
                Website Development?
              </h4>
              <p className="text-figtree text-black mt-2">
                A professionally developed dynamic website makes it simple to
                manage your online content. Administrators can update pages,
                services, products, images, blogs, testimonials, and other
        ...
        {sectionsData.map((item, index) => {
          ...
          return (
            <div
              key={index}
              className={`row align-items-center mt-3 gy-4 gy-lg-5 feature-row ${isEven ? "flex-lg-row-reverse" : ""}`}
              data-aos="fade-up"
              data-aos-delay="200"
            >
              {/* Text Content Column */}
