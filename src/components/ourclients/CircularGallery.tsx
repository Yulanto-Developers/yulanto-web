...
function createTextTexture(gl: any, text: string, font: string = 'bold 30px monospace', color: string = 'black'): { texture: any; width: number; height: number } {
...
class App {
  ...
  private boundOnTouchDown!: (e: TouchEvent | MouseEvent) => void;
  private boundOnTouchMove!: (e: TouchEvent | MouseEvent) => void;
