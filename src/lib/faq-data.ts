export const faqData = {
  ...
  "website-redesign-in-chennai": [
    {
      ...
      answer:
        "Website redesign cost in Chennai depends on the website size, number of pages, design complexity, technology, functionality, integrations, content requirements, and the extent of the redesign. A basic website revamp usually costs less than a complete website redesign involving new layouts, functionality, content, SEO, and integrations.",
    },
    {
      question: "How long does it take to redesign a website?",
      answer:
        "A website redesign typically takes around 2 to 4 weeks for a standard website, depending on its size, number of pages, design requirements, content, and functionality. Larger websites with custom features, integrations, or extensive content migration may require additional development time.",
    },
    {
      question: "Will a website redesign affect my Google rankings and SEO?",
      answer:
        "A website redesign can affect Google rankings if important SEO elements are changed or removed without proper planning. During a website redesign, we consider existing URLs, metadata, content, headings, internal links, redirects, structured data, mobile usability, and other SEO factors to minimize unnecessary ranking risks.",
    },
    {
      question: "Can you redesign an existing WordPress website?",
      answer:
        "Yes, we provide WordPress website redesign services for existing websites while retaining useful content, features, integrations, and functionality where appropriate. If the existing WordPress structure limits performance, scalability, or design flexibility, specific sections can also be rebuilt or improved.",
    },
    {
      question: "Can website redesign improve leads and conversions?",
      answer:
        "Yes, a conversion-focused website redesign can improve lead generation by making navigation, user experience, calls-to-action, content presentation, mobile usability, and conversion paths more effective. The redesign can also focus on helping visitors find important information and contact your business more easily.",
    },
    {
      question:
        "Do you provide website redesign services for small businesses?",
      answer:
        "Yes, we provide small business website redesign services focused on creating professional, responsive, SEO-friendly, and conversion-focused websites. The redesign can improve website usability, mobile experience, content structure, calls-to-action, and online visibility based on the requirements of a growing business.",
    },
    {
      question: "How can I find a website redesign company in Chennai?",
      answer:
        "You can find a website redesign company in Chennai by comparing its redesign experience, portfolio, SEO approach, responsive design capabilities, technical expertise, and understanding of your business requirements. A Chennai-based website redesign team can review your existing website and recommend improvements based on its design, performance, usability, SEO, and business goals.",
    },
    {
      question: "What is included in a website redesign service?",
      answer:
        "A website redesign service can include UI and UX improvements, responsive design, page layout updates, content restructuring, SEO optimization, navigation improvements, calls-to-action, performance improvements, and functionality updates. The exact redesign scope depends on the existing website, business requirements, technical platform, and project goals.",
    },
    {
      question: "How do I know if my website needs a redesign?",
      answer:
        "Your website may need a redesign if it has an outdated design, poor mobile experience, slow performance, difficult navigation, low conversions, outdated content, or technical and SEO issues. A website redesign can help improve usability, performance, search visibility, and the overall experience for visitors.",
    },
  ],
  ...
  "ui-ux-companies-in-chennai": [
    {
      ...
      answer:
        "You can find the right UI UX design services near you by checking local design studios, digital agencies or freelance UI UX designers in your city. Review their portfolio, process, usability approach and past work to confirm they match your website, app or product goals.",
    },
    {
      question: "Why is UI UX design important for a website or app?",
      answer:
        "Good UI UX design improves usability, reduces friction, builds trust and helps users complete tasks faster. It directly impacts engagement, retention, conversions and overall customer satisfaction—making it essential for both business and user goals.",
    },
    {
      question: "What does a UI UX design service include?",
      answer:
        "A UI UX design service typically includes user research, wireframes, user flows, information architecture, UI design, prototyping, usability testing and design handoff. The exact scope depends on the product type, target users, business goals and development requirements.",
    },
    {
      question: "Do you provide custom UI UX design services?",
      answer:
        "Yes. We provide custom UI UX design tailored to your brand, target audience, product goals and business requirements—rather than relying on generic templates. Custom design ensures better usability, brand consistency and a more engaging user experience.",
    },
    {
      question: "How does UI UX design improve conversions?",
      answer:
        "UI UX design improves conversions by simplifying navigation, reducing friction, clarifying calls-to-action and guiding users toward the desired action. Better usability and visual hierarchy help users find information faster and complete tasks with fewer distractions.",
    },
    {
      question: "Is UI UX design important for mobile responsiveness?",
      answer:
        "Yes. UI UX design ensures layouts, navigation, forms and interactions work smoothly across smartphones, tablets, laptops and desktops. A responsive UI UX approach provides a consistent and accessible experience on every screen size.",
    },
    {
      question: "How long does a UI UX design project take?",
      answer:
        "UI UX design timelines depend on project scope, number of screens, complexity, research requirements, content availability and feedback cycles. A small website UI UX project may take a few weeks, while larger apps or platforms with multiple user flows can take longer.",
    },
    {
      question: "Do you provide UI UX design services in Chennai?",
      answer:
        "Yes. We provide UI UX design services in Chennai for websites, web apps, mobile apps and digital products—focused on usability, accessibility and conversion. Our UI UX process is tailored to each client's brand, audience and business objectives.",
    },
    {
      question:
        "Can you redesign an existing website or app with better UI UX?",
      answer:
        "Yes. We redesign existing websites and apps with improved UI, streamlined UX, better navigation, responsive layouts and clearer calls-to-action. A UI UX redesign can fix usability issues, outdated design, poor mobile experience and low engagement.",
    },
  ],
  ...
  "our-story": [
    {
      question: "When was Yulanto Web Creations established?",
      answer:
        "Yulanto Web Creations was established in 2015 to provide professional web design, web development and digital solutions.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "Yulanto Web Creations provides website design, web development, eCommerce development, API integration and other digital solutions.",
    },
  ],
} as const;
