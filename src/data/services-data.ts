...
your audience.`,
  ...
  },
  {
    ...
    description:
      "As experienced web developers in Chennai, we build fast, secure, and scalable websites with custom web development solutions and responsive web applications tailored to achieve your business goals.",
    subDesc:
      "At Yulanto Web Creations, we provide reliable and result-driven web development services in Chennai to help businesses establish a strong online presence. As an experienced Web Development Company in Chennai, we develop responsive, secure, and high-performance websites tailored to your business requirements.",
    categories: [
      "Web Developers",
  ...
  },
  {
    ...
    description:
      "As a trusted eCommerce Website Development Company in Chennai, we build secure, scalable, and mobile-friendly online stores using WooCommerce, Shopify, and custom eCommerce solutions.",
    subDesc:
  ...
  },
  {
    ...
    description:
      "Create a powerful brand identity with our professional graphic design services in Chennai. We design eye-catching logos, brochures, business cards, social media creatives, flyers, banners, and marketing materials that reflect your brand.",
    subDesc:
  ...
  },
  {
    ...
    description:
      "Grow your business online with our professional Digital Marketing Services in Chennai. We provide SEO, Google Ads, Social Media Marketing (SMM), Meta Ads to increase your website traffic, generate quality leads, and improve online visibility.",
    subDesc:
      "we provide result-oriented Digital Marketing Services in Chennai to help businesses increase their online visibility, attract qualified leads, and achieve sustainable growth. As a trusted Digital Marketing Company in Chennai, we create customized marketing strategies tailored to your business goals and target audience.",
    categories: [
      "Digital Marketing",
